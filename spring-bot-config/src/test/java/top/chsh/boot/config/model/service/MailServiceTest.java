package top.chsh.boot.config.model.service;
...
public class MailServiceTest {
    ...
    void sendSimpleMail() {
        Mail mail = new Mail();
        mail.setTo("2975803810@qq.com");
        mail.setSubject("测试邮件");
        mail.setContent("测试邮件内容");
        ResultStatus result = mailService.sendSimpleMail(mail);
    ...
    void sendAttachmentsMail() throws Exception {
        ...
        // 本地文件
        File file1 = new File("src/main/resources/img/1.jpg");
        File file2 = new File("src/main/resources/img/2.jpg");
